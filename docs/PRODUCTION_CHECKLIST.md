...
Required public routes: `/api/meta/oauth/callback`, `/api/meta/webhook`, `/privacy`, `/data-deletion`.
...
- [ ] Confirm production environment validation accepts only real PostgreSQL, session, admin, Meta, and DeepSeek values; no example values.
