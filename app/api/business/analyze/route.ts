...
import { createPageDeepSeekProvider } from "@/services/ai/provider";
...
export async function POST(request: Request) {
  ...
  try {
    const result = normalizeBusinessParse(await analyzeBusiness({ ...parsed.data, provider: await createPageDeepSeekProvider(parsed.data.pageId) }));
