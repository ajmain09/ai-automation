...
const paths: Record<(typeof tabs)[number], string> = { Overview: "", Business: "/business", Products: "/products", Conversations: "", Customers: "", Orders: "/orders", "AI Usage": "/usage", Settings: "/settings" };
