...
const tabs = ["Overview", "Business", "Products", "AI", "Conversations", "Customers", "Orders", "AI Usage", "Settings"] as const;
const paths: Record<(typeof tabs)[number], string> = { Overview: "", Business: "/business", Products: "/products", AI: "/ai", Conversations: "/conversations", Customers: "/customers", Orders: "/orders", "AI Usage": "/usage", Settings: "/settings" };
